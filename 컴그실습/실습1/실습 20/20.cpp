...
GLvoid drawScene() {
	...
	glViewport(0, 0, 800,800);
	{
		...
		Rx = glm::rotate(Rx, glm::radians(40.0f), glm::vec3(1.0, 0.0, 0.0));
	...
	projection = glm::ortho(-6.0f,6.0f, -6.0f, 6.0f, -6.0f, 6.0f); //--- 투영 공간 설정: [-100.0, 100.0]
	projectionLocation = glGetUniformLocation(shaderProgram, "projectionTransform"); //--- 투영 변환 값 설정
	glUniformMatrix4fv(projectionLocation, 1, GL_FALSE, &projection[0][0]);
